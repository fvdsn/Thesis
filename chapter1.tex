...
\chapter{Présentation des frameworks d'édition d'images}
	...
	\section{Fonctionnalités d'un framework d'édition d'image}
		\subsection{Opérations de dessin}
			...
			\subsubsection{Filtres}
				...
				\begin{figure}[h]
					\centering
					\subfloat[Image originale]{ \label{fig:lenna_a} \includegraphics[width=0.3\textwidth]{images/Lenna} }
					\subfloat[Filtre colorimétrique]{ \label{fig:lenna_b} \includegraphics[width=0.3\textwidth]{images/Lenna-green} }
					\subfloat[Filtre spatial \emph{Sobel}]{ \label{fig:lenna_c} \includegraphics[width=0.3\textwidth]{images/Lenna-sobel} }
		...
		\subsection{Modèles colorimétriques}
			...
			\begin{figure}[h]
				...
				\subfloat[Format HSL en fausses couleurs]{ \label{fig:render-hsv} \includegraphics[width=0.25\textwidth]{images/render-hsv} }
	...
	\section{Frameworks Nodaux}
		\subsection{Schéma de représentation de l'image}
			\begin{figure}[h]
				\centering
				\subfloat[En rouge les noeuds d'entrée, en orange les noeuds d'opération, en vert les noeuds de visualisation]{\includegraphics[width=0.8\textwidth]{images/nodes} }
				\\
				\subfloat[Image calculée par le graphe (a)]{\includegraphics[width=0.4\textwidth]{images/nodes-out} }
	...
	\section{Framework vectoriel}
		\subsection{Schéma de représentation de l'image}
			\begin{figure}[h]
				\centering
				\subfloat[l'image]{\includegraphics[width=0.33\textwidth]{images/scenegraph-img} }
				\subfloat[Le graphe de scène]{ \includegraphics[width=0.66\textwidth]{images/scenegraph-graph} }
	...
	\section{Mégatexturing ou Sparse Virtual Textures}
		...
		\subsection{Schéma de représentation de l'image}
			\begin{figure}[h]
				\centering
				\subfloat[La pyramide de tile représentant l'image complète]{\includegraphics[width=0.6\textwidth]{images/megatextures-pyramid} }
				\subfloat[La texture virtuelle, composée de tiles de la pyramide]{\includegraphics[width=0.4\textwidth]{images/megatextures-virtual} }
				\caption{Mégatexture}
