\chapter{Présentation du Framework Himalaya}
	...
	\section{Structures de données}
		...
		\subsubsection{Structure du tile}
			...
			\begin{figure}[h]
				\centering
				\subfloat[Un tile normal]{\includegraphics[width=0.5\textwidth]{images/tile-a} }
				\subfloat[Un tile aux canaux séparés]{\includegraphics[width=0.5\textwidth]{images/tile-b} }
