\chapter{Présentation des frameworks d'édition d'images}
	...
	Pour réaliser cette présentation nous nous sommes basé sur une lecture du code source des différents frameworks open-source, afin d'évaluer
	les structures de données et les algorithmes utilisés. Nous avons également étudié les fonctionalités et performances des
	...
	\section{Fonctionalités d'un framework d'édition d'image}
		...
		\subsection{Images gigapixels}
			...
			vive disponible. Avec l'évolution des capteurs photographiques et des espaces de stockages, ce type d'image est utilisé de plus en plus
			fréquemment. Astronomie, cartographie, jeux vidéos, sont autant de domaines faisant usage de telles images. 
	...
	\section{Frameworks Nodaux}
		...
		\subsection{Framework nodaux, l'état de l'art}
			\begin{description}
				...
				\item[eyeon cineon]Logiciel de composition et post processing vidéo
	...
	\section{Framework vectoriel}
		...
		\subsection{Framework Vectoriels, l'état de l'art}
			\begin{description}
				...
				\item[Anti Grain Geometry]Librairie open source de rendu et d'édition graphique vectorielle, utilisée par Haiku OS.
				\item[Qt4]Librairie d'interface graphique open source utilisée par KDE.
				\item[Apple Quartz 2D]Librairie de rendu et d'édition graphique vectorielle, utilisé par Apple OSX et de nombreux logiciels de cette plateforme
				\item[Microsoft GDI+]Librairie de rendu graphique vectoriel, utilisé par Microsoft Windows et de nombreux logiciels de cette plateforme.
	...
	\begin{table*}
		...
		\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} | l || c | c | c | c |}
			...
			Transformations géométriques   	& $\ominus$		& $\ominus$		& $\medbullet$	 	& $\ominus$	\\
			...
			Modèles étendus		   	& $\ocircle$		& $\medbullet$		& $\ocircle$	 	& $\ocircle$	\\
	...
	ensuite sur l'implémentation et l'évaluation par test utilisateurs des fonctionalités de peinture et d'édition d'images gigapixel.
