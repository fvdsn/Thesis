\chapter{Test utilisateurs}
	...
	\begin{figure}[h]
		\centering
		\subfloat[Portrait couleur par \emph{Brice Vandemoortele}]{\includegraphics[width=0.45\textwidth]{images/paintings/brice1} }
		\subfloat[Homme avec puce sur un éléphant par \emph{Brice Vandemoortele}]{\includegraphics[width=0.45\textwidth]{images/paintings/brice2} }
		\\
		\subfloat[Portrait couleur par \emph{Jean-Philippe Servais}]{\includegraphics[width=0.45\textwidth]{images/paintings/jf1} }
		\subfloat[Portrait au trait par \emph{Jean-Philippe Servais}]{\includegraphics[width=0.45\textwidth]{images/paintings/jf2} }
